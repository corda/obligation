...
class ObligationFlowTests {
    ...
    fun `create obligation then cancel it`() {
        ...
        val obligationId = tx.toLedgerTransaction(aliceNode.services).singleOutput<com.r3.corda.lib.obligation.states.Obligation<TokenType>>().linearId
        ...
        Thread.sleep(100)
        assertNull(aliceNode.transaction { aliceNode.services.vaultService.queryBy<com.r3.corda.lib.obligation.states.Obligation<TokenType>>(query).states.singleOrNull() })
        assertNull(bobNode.transaction { bobNode.services.vaultService.queryBy<com.r3.corda.lib.obligation.states.Obligation<TokenType>>(query).states.singleOrNull() })
    }
    ...
    fun `anonymous obligation parties are confidential to the parties involved`() {
        ...
        val publicOblicationId = publicTx.toLedgerTransaction(aliceNode.services).singleOutput<com.r3.corda.lib.obligation.states.Obligation<TokenType>>().linearId
        val anonOblicationId = anonTx.toLedgerTransaction(aliceNode.services).singleOutput<com.r3.corda.lib.obligation.states.Obligation<TokenType>>().linearId
    ...
    fun `novate obligation currency`() {
        ...
        val novationCommand = com.r3.corda.lib.obligation.commands.ObligationCommands.Novate.UpdateFaceAmountToken(
                oldToken = USD,
                newToken = XRP,
        ...
        val novatedObligation = result.toLedgerTransaction(aliceNode.services).singleOutput<com.r3.corda.lib.obligation.states.Obligation<TokenType>>()
